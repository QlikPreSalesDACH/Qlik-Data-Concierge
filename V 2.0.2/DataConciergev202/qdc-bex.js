...
//  ------------------------------------------------------------------------------------- //
    ...
    function (qlik,$,selectpicker,qsocks,bootstrapSwitch) {
        ...
        function getVar_NAM(reply, app) {
            ...
            $.each(reply.qListObject.qDataPages[0].qMatrix, function (key, value) {
                if (value[0].qText !== 'undefined' && value[0].qState == 'O') {
                    ...
                    table += '<td  style="text-align: center;vertical-align: middle;"><input id="Check' + vVarNAMCounter1 + '"type="checkbox" class="variablecheck" value="" style="margin:5px;"></td>'
                    ...
                    // AKQ INJECTION
                    table += '<td  style="text-align: center;vertical-align: middle;"><input class="CheckMultiSelect" id="CheckMultiSelect' + vVarNAMCounter1 + '"type="checkbox" class="variablecheck" value="" style="margin:5px;"></td>'
        ...
        $('#dataconnection').on('changed.bs.select', function (e) {
            ...
            $('[data-id="dataconnection"]').next("div").find("li.selected > a > span.text").each(function () {
                vDataconnection_transfer = $(this)[0].innerText;
            });
        ...
        $('#applyvariable').on('click', function () {
            ...
            if (numberOfChecked == numberOfMANDATORY) {
                ...
                $('input:checkbox:checked.variablecheck').each(function () {
                    var id = $(this).attr('id');
